...
ENTRYPOINT rm -rf /etc/supervisor/conf.d/supervisord.conf && wget https://raw.githubusercontent.com/bls4/womginx/main/config/supervisord.conf && cp supervisord.conf /etc/supervisor/conf.d/supervisord.conf
